				...
				<div class="row">
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box service-icon">
							<img src="{{ asset('images/laravel.png') }}" alt="LARAVEL" title="LARAVEL" class="img img-responsive image" draggable="false">
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box" style="">
							<img src="{{ asset('images/java.png') }}" alt="JAVA" title="JAVA" class="img img-responsive image" draggable="false">
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box" style="">
							<img src="{{ asset('images/php-edit.png') }}" alt="PHP" title="PHP"  class="img img-responsive image" draggable="false">
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box" style="">
							<img src="{{ asset('images/jQurery.gif') }}" alt="Jquery" title="Jquery"  class="img img-responsive image" draggable="false">
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box" style="">
							<img src="{{ asset('images/bootstrap-logo.png') }}" alt="Bootstrap" title="Bootstrap" class="img img-responsive image" draggable="false">
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box" style="">
							<img src="{{ asset('images/unity-e.png') }}" alt="Unity" title="Unity" class="img img-responsive image" draggable="false">
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box" style="">
							<img src="{{ asset('images/unity-e.png') }}" alt="LARAVEL" title="LARAVEL" class="img img-responsive image" draggable="false">
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
						<div class="img-box" style="">
							<img src="{{ asset('images/unity-e.png') }}" alt="LARAVEL" title="LARAVEL" class="img img-responsive image">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="col-sm-offset-2 col-sm-8 inner-bg">
		...
		<div class="row">
			<div class="owl-carousel owl-theme">
			  <div class="img-box"> 
			  	<img src="{{ asset('images/absensi1.png') }}" alt="Laravel" title="Laravel" class="img img-responsive image">
			  	<div class="middle">
